...
const S = StyleSheet.create({
  ...
  avatar: { width: 56, height: 56, borderRadius: 28, backgroundColor: "#3a0000", alignItems: "center", justifyContent: "center" },
  ...
  menuIcon: { width: 38, height: 38, borderRadius: 10, backgroundColor: "#3a0000", alignItems: "center", justifyContent: "center" },
  menuLabel: { flex: 1, color: "#fff", fontSize: 15, fontWeight: "600" },
  divider: { height: 1, backgroundColor: "#0d0000", marginLeft: 66 },
});
